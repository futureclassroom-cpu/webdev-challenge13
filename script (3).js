...
// ======================================
const GEMINI_API_KEY = "AIzaSyDbDmBcXr15E9mHJ3HV-NCZwPrxrkWoGbE";
...
function generateReflection() {
  ...
  // Prompt updated to discourage markdown formatting which causes JSON errors
  const message = 'You are a helpful lifestyle coach. The user says: ' + userText + 
                  ...
                  'Output only the raw JSON. Do not include ```json or other formatting.';
